...
public class WebAssemblyArrayNewInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyArrayNewInstr {

  public WebAssemblyArrayNewInstrImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitArrayNewInstr(this);
  }
