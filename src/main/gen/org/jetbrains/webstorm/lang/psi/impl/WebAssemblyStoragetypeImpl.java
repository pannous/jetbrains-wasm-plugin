...
public class WebAssemblyStoragetypeImpl extends ASTWrapperPsiElement implements WebAssemblyStoragetype {

  public WebAssemblyStoragetypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitStoragetype(this);
  }
