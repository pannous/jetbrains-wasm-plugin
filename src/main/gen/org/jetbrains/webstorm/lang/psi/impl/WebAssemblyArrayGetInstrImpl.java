...
public class WebAssemblyArrayGetInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyArrayGetInstr {

  public WebAssemblyArrayGetInstrImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitArrayGetInstr(this);
  }
