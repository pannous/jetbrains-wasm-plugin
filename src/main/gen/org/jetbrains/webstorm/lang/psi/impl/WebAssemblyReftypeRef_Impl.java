...
public class WebAssemblyReftypeRef_Impl extends ASTWrapperPsiElement implements WebAssemblyReftypeRef_ {

  public WebAssemblyReftypeRef_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitReftypeRef_(this);
  }
