...
public class WebAssemblyTypeImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyType {
  ...
  public WebAssemblyTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WebAssemblyArraytype getArraytype() {
    return findChildByClass(WebAssemblyArraytype.class);
  }
  ...
  @Override
  @Nullable
  public WebAssemblyStructtype getStructtype() {
    return findChildByClass(WebAssemblyStructtype.class);
  }
