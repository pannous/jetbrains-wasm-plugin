...
public class WebAssemblyArraySetInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyArraySetInstr {

  public WebAssemblyArraySetInstrImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitArraySetInstr(this);
  }
