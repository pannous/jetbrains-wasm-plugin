...
public class WebAssemblyHeaptypeImpl extends ASTWrapperPsiElement implements WebAssemblyHeaptype {

  public WebAssemblyHeaptypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitHeaptype(this);
  }
