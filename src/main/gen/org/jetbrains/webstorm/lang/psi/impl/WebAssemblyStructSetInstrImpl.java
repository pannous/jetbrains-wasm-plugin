...
public class WebAssemblyStructSetInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyStructSetInstr {

  public WebAssemblyStructSetInstrImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitStructSetInstr(this);
  }
