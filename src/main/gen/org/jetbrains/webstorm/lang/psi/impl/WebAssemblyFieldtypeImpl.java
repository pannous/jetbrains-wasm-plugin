...
public class WebAssemblyFieldtypeImpl extends ASTWrapperPsiElement implements WebAssemblyFieldtype {

  public WebAssemblyFieldtypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WebAssemblyStoragetype getStoragetype() {
    return findNotNullChildByClass(WebAssemblyStoragetype.class);
  }
