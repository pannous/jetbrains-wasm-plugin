...
public class WebAssemblyArraytypeImpl extends ASTWrapperPsiElement implements WebAssemblyArraytype {

  public WebAssemblyArraytypeImpl(@NotNull ASTNode node) {
    super(node);
  }
