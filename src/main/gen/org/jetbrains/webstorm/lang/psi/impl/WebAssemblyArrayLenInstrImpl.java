...
public class WebAssemblyArrayLenInstrImpl extends ASTWrapperPsiElement implements WebAssemblyArrayLenInstr {

  public WebAssemblyArrayLenInstrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitArrayLenInstr(this);
  }
