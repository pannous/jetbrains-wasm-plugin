...
public class WebAssemblyStructNewInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyStructNewInstr {

  public WebAssemblyStructNewInstrImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitStructNewInstr(this);
  }
