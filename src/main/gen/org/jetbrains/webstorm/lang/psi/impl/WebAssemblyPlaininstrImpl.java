...
public class WebAssemblyPlaininstrImpl extends ASTWrapperPsiElement implements WebAssemblyPlaininstr {
  ...
  @Override
  @Nullable
  public WebAssemblyArrayGetInstr getArrayGetInstr() {
    return findChildByClass(WebAssemblyArrayGetInstr.class);
  }
  ...
  @Override
  @Nullable
  public WebAssemblyArraySetInstr getArraySetInstr() {
    return findChildByClass(WebAssemblyArraySetInstr.class);
  }
  ...
  @Override
  @Nullable
  public WebAssemblyStructGetInstr getStructGetInstr() {
    return findChildByClass(WebAssemblyStructGetInstr.class);
  }

  @Override
  @Nullable
  public WebAssemblyStructNewInstr getStructNewInstr() {
    return findChildByClass(WebAssemblyStructNewInstr.class);
  }

  @Override
  @Nullable
  public WebAssemblyStructSetInstr getStructSetInstr() {
    return findChildByClass(WebAssemblyStructSetInstr.class);
  }
