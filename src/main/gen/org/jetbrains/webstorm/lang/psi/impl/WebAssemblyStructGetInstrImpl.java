...
public class WebAssemblyStructGetInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyStructGetInstr {

  public WebAssemblyStructGetInstrImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitStructGetInstr(this);
  }
