...
// types (updated)
NUMTYPE = [if] (32 | 64)
REFTYPE = "funcref" | "externref" | "anyref" | "eqref" | "i31ref" | "structref" | "arrayref" | "nullref"
        // WebAssembly v1.0
        | "anyfunc"
PACKEDTYPE = "i8" | "i16"
...
EXTERNCONVERT = (extern|any)\.(convert_any|externalize|internalize)
...
STRUCTNEW = struct\.new(_default)?
STRUCTGET = struct\.get(_[su])?
STRUCTSET = struct\.set

// GC array instructions
ARRAYNEW = array\.(new(_default|_fixed|_data|_elem)?)
ARRAYGET = array\.get(_[su])?
ARRAYSET = array\.set
ARRAYLEN = array\.len
...
<YYINITIAL> {
    ...
    {REFTEST}                   { return REFTEST; }
    {REFCAST}                   { return REFCAST; }
    {REFEQ}                     { return REFEQ; }
    {REFI31}                    { return REFI31; }
    {I31GET}                    { return I31GET; }
    {REFASNONNULL}              { return REFASNONNULL; }
    {EXTERNCONVERT}             { return EXTERNCONVERT; }

    {STRUCTNEW}                 { return STRUCTNEW; }
    {STRUCTGET}                 { return STRUCTGET; }
    {STRUCTSET}                 { return STRUCTSET; }
    {ARRAYNEW}                  { return ARRAYNEW; }
    {ARRAYGET}                  { return ARRAYGET; }
    {ARRAYSET}                  { return ARRAYSET; }
    {ARRAYLEN}                  { return ARRAYLEN; }
    {ARRAYCOPY}                 { return ARRAYCOPY; }
    {ARRAYFILL}                 { return ARRAYFILL; }
    {ARRAYINITDATA}             { return ARRAYINITDATA; }
    {ARRAYINITELEM}             { return ARRAYINITELEM; }
